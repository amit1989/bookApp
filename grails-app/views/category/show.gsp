	...
	<body>
		...
		<div id="show-category" class="content scaffold-show" role="main">
			...
			<ol class="property-list category">
				...
				<g:if test="${categoryInstance?.discription}">
				<li class="fieldcontain">
					<span id="discription-label" class="property-label"><g:message code="category.discription.label" default="Discription" /></span>
					
						<span class="property-value" aria-labelledby="discription-label"><g:fieldValue bean="${categoryInstance}" field="discription"/></span>
